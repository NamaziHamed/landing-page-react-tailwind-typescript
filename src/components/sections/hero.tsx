      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
          <span
            ...
            top-24 lg:top-28 w-24 h-24 rotate-90 skew-x-12
        ...
        >
          <h1
            className="text-heading-1 text-3xl sm:text-4xl md:text-5xl lg:text-6xl
          font-bold"
          >
          ...
          <Paragraph className="mt-8">
            Welcome to Codex By Hamed—where creativity meets code, and
            innovation powers digital transformation. We craft stunning,
            high-performance websites that captivate audiences, elevate brands,
            and deliver seamless user experiences. Your vision, our
            expertise—let’s build something extraordinary together.
          </Paragraph>
          <div className="mt-10 w-full flex mx-w-md mx-auto lg:max-0">
